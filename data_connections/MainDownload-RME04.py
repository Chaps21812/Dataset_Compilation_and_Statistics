...
if __name__ == "__main__":
    ...
    downloader = S3Client(RME04_PATH)
    for date in RME04_dates:
        print(date)
        downloader.download_annotation_dates(date, "/data/Dataset_Compilation_and_Statistics/Sentinel_Datasets/RME04-2025_Annotations")
